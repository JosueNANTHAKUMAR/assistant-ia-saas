...
export default function Chat() {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-gray-100 font-sans antialiased overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 bg-gray-950 border-r border-gray-800 hidden md:flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          <div className="text-xs font-medium text-gray-500 uppercase tracking-wider">History</div>
          {/* Mock History Items */}
          {[1, 2, 3].map((i) => (
            <button
              key={i}
        ...
        <div className="p-4 border-t border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm">
              <div className="font-medium text-white">Josue S.</div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 scroll-smooth">
          {messages.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center text-center p-8 opacity-50">
              ...
              <p className="text-gray-500 max-w-md mt-2">
                Ask me anything about your health data, reports, or general inquiries.
              </p>
            </div>
          )}
          ...
          {messages.map((m: any) => (
            ...
            >
              ...
              {m.role === "user" && (
                <div className="w-8 h-8 rounded-full bg-blue-900/30 flex items-center justify-center flex-shrink-0 border border-blue-800">
